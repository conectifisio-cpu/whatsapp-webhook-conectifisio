...
# ==========================================
# INTEGRAÇÃO FEEGOW (BUSCA POR TELEFONE INCLUÍDA!)
# ==========================================
...
# Busca direta pelo Telemóvel na Feegow
...
def webhook():
    ...
    try:
        ...
        # NOVO: Verificação de Veterano baseada na existência do Feegow ID!
        ...
        if status == "triagem":
            ...
            if msg_recebida not in ["São Caetano", "Ipiranga"]:
                ...
                if is_veteran:
                    nome_salvo = info.get("title", "Paciente").split()[0] # Pega só o primeiro nome
            ...
            if "Novo Serviço" in msg_recebida:
                ...
                secoes = [{"title": "Serviços de Secretaria", "rows": [{"id": "s1", "title": "Declaração de Horas"}, {"id": "s2", "title": "Relatório Fisioterapêutico"}, {"id": "s3", "title": "Atualização Cadastral"}, {"id": "s4", "title": "⬅️ Voltar ao Menu"}]}]
